...
{
  "$end", "error", "$undefined", "DIGIT", "PLUS", "MINUS", "MUL", "DIV",
  "MOD", "LEFT", "RIGHT", "END", "$accept", "start", "expr", YY_NULLPTR
};
#endif
...
{
      20,    -3,    20,     1,     6,    14,    -3,    20,    20,    20,
      20,    20,    -3,    -3,    26,    26,    26,    26,    26
};
